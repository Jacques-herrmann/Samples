 ...
 * Use InstancedMesh
 * 
 * If you cannot merge the geometries because you need to have control over the meshes independently, but they are using the same 
 * geometry and same material, you can use an InstancedMesh.
 * 
 * It's like a mesh, but you create only one InstancedMesh, and then you provide a transformation matrix for each "instance" of that 
 * mesh.
 * 
...
const shaderMaterial = new THREE.ShaderMaterial({
    ...
    vertexShader: `
        ...
        void main()
        {
            ...
            modelPosition.y += max(elevation, 0.5) * DISPLACEMENT_STRENGH;
